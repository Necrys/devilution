...
BOOL STORMAPI SNetEnumProviders(int(STORMAPI *callback)(DWORD, DWORD, DWORD));
...
BOOL STORMAPI SNetReceiveTurns(int a1, int arraysize, unsigned char **arraydata, unsigned int *arraydatabytes, DWORD *arrayplayerstatus);
